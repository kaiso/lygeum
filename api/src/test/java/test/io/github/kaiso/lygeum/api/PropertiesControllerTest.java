...
public class PropertiesControllerTest {
    ...
    mockMvc =
        MockMvcBuilders.standaloneSetup(
                new PropertiesController(
                    propertiesManager, applicationsManager, environmentsManager))
  ...
  @WithMockUser(
      authorities = {
        AuthorizationManager.ROLE_PREFIX + "PROD_READ",
    ...
    new Expectations() {
      {
        ...
        res.add(
            PropertyEntity.builder()
                .withName("author")
                .withValue("Kais OMRI")
                .withEnvironment(new EnvironmentEntity("prod", "production"))
                .build());
        result = res;
      }
    };
    RequestBuilder requestBuilder =
        MockMvcRequestBuilders.get("/lygeum/api/properties")
  ...
  @WithMockUser(
      authorities = {
        AuthorizationManager.ROLE_PREFIX + "PROD_UPDATE",
  ...
  public void should_update_properties() throws Exception {
    ...
    RequestBuilder requestBuilder =
        MockMvcRequestBuilders.post("/lygeum/api/properties")
            .accept(MediaType.APPLICATION_JSON)
  ...
  public void should_download_properties_layout() throws Exception {
    ...
    RequestBuilder requestBuilder =
        MockMvcRequestBuilders.get("/lygeum/api/properties/download")
            .accept(MediaType.APPLICATION_JSON)
            .param("env", "prod")
            .param("app", "application")
  ...
  public void should_upload_error_on_invalid_mime() throws Exception {
    ...
    MvcResult result =
        this.mockMvc
            .perform(
                MockMvcRequestBuilders.multipart("/lygeum/api/properties/upload")
                    .file(multipartFile)
                    .param("env", "prod")
                    .param("app", "application"))
            .andReturn();
  ...
  public void should_upload_properties_layout() throws Exception {
    ...
    MockMultipartFile multipartFile =
        new MockMultipartFile(
            "file",
            "test.properties",
            PropertiesMediaType.PROPERTIES.value(),
  ...
  public void should_upload_yaml_layout() throws Exception {
    ...
    MockMultipartFile multipartFile =
        new MockMultipartFile(
            "file", "test.yaml", PropertiesMediaType.YAML.value(), content.getBytes());
    MvcResult result =
        this.mockMvc
            .perform(
                MockMvcRequestBuilders.multipart("/lygeum/api/properties/upload")

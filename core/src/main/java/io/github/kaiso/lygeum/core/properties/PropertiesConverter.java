...
public final class PropertiesConverter {
  ...
  public static Object convertPropertiesMapToJson(Map<String, String> properties)
      throws IOException {
    return javaPropsMapper.readValue(getPropertiesMapAsString(properties), Object.class);
  }

  public static String convertPropertiesMapToJsonString(Map<String, String> properties)
      throws IOException {
    ObjectMapper javaPropsReader = new ObjectMapper(new JavaPropsFactory());
    Object obj = javaPropsReader.readValue(getPropertiesMapAsString(properties), Object.class);
  ...
  public static String getPropertiesMapAsString(Map<String, String> properties) {
    ...
    properties
        ...
        .stream()
        .sorted(
            (Entry<String, String> e1, Entry<String, String> e2) ->
